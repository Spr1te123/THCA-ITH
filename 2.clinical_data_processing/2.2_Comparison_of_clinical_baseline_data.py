...
# 确保输出目录存在
OUTPUT_DIR = '/results/Comparison_of_clinical_baseline_data'
...
def load_and_prepare_data():
    ...
    # 加载数据
    train_data = pd.read_csv('/data/clinical_features_zlyy.csv')
    external_data = pd.read_csv('/data/clinical_features_ydyy.csv')
...
def save_results(results_df, notes):
    """保存结果"""
    output_file = '/results/Comparison_of_clinical_baseline_data/clinical_comparison_table.xlsx'
    ...
    # 同时保存CSV版本
    csv_file = '/results/Comparison_of_clinical_baseline_data/clinical_comparison_table.csv'
