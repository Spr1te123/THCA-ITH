...
class MultiCenterAnalysis:
    ...
    def run_all_evaluations(self):
        ...
        # 1. 训练集（手动标注基线）
        print("\n【1. 手动标注基线】")
        path_train_a = '/data/Thyroid_Cancer_Lesion_CT_Mask_Segmentation/doctorA_annotated_masks_zlyy'
        path_train_b = '/data/Thyroid_Cancer_Lesion_CT_Mask_Segmentation/doctorB_modified_masks_zlyy'
        ...
        # 2. 测试集A
        print("\n【2. 测试集A - 中心A】")
        path_test_a_pred = '/data/Thyroid_Cancer_Lesion_CT_Mask_Segmentation/nnUNet_Predicted_Mask_zlyy'
        path_test_a_mod = '/data/Thyroid_Cancer_Lesion_CT_Mask_Segmentation/doctorB_Modified_nnUNet_Predicted_Mask_zlyy'
        ...
        # 3. 测试集B
        print("\n【3. 测试集B - 中心B】")
        path_test_b_pred = '/data/Thyroid_Cancer_Lesion_CT_Mask_Segmentation/nnUNet_Predicted_Mask_ydyy'
        path_test_b_mod = '/data/Thyroid_Cancer_Lesion_CT_Mask_Segmentation/doctorB_Modified_nnUNet_Predicted_Mask_ydyy'
...
def main():
    ...
    output_dir = os.path.join('/results', "Radiology_Analysis", f"Run_{timestamp}")
