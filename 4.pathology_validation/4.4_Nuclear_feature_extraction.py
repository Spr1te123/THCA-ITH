...
def main():
    ...
    parser.add_argument('--results-dir', default='/results/nuclear_segmentation',
    ...
    parser.add_argument('--target-image', default='/data/reference_all_wsi/reference_macenko.png',
