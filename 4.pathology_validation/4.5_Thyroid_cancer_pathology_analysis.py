...
#采用筛查阈值后的风险分组
LOW_RISK_PATIENTS = [47, 554, 560, 592, 607, 619]
HIGH_RISK_PATIENTS = [365, 491, 514, 518, 552, 557]

# 添加真实临床结局（仅用于综合评分计算）
NON_METASTASIS_PATIENTS = [47, 365, 554, 560, 592, 607, 619]
METASTASIS_PATIENTS = [491, 514, 518, 552, 557]

# 数据路径
DATA_DIR = "/data/model_interpretation"  # 输入数据目录
OUTPUT_DIR = "/results/model_interpretation_results"  # 输出结果目录
